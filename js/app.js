(() => {
    ...
    (() => {
        ...
        rangeInit();
        function rangeInitAll() {
            const rangeItemsAll = document.querySelectorAll("[data-range-all]");
            if (rangeItemsAll.length) rangeItemsAll.forEach((rangeItemAll => {
                ...
                nouislider.create(itemAll, {
                    start: [ Number(fromValueAll.value), Number(toValueAll.value) ],
                    connect: true,
                    range: {
                    ...
                    inputAll.addEventListener("keydown", (function(e) {
                        ...
                        switch (e.which) {
                          ...
                          case 38:
                            position = step[1];
                            if (false === position) position = 1;
                            if (null !== position) itemAll.noUiSlider.setHandle(handle, value + position);
                            break;
        ...
        function initSliders() {
            ...
            if (document.querySelector(".product-new__slider")) new core(".product-new__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                watchOverflow: true,
                observeParents: true,
        ...
        if (availability) {
            if ("yes" == availability.dataset.availability) {
                availability.style.color = `#24AD53`;
                availability.textContent = `В наличии`;
            }
            if ("no" == availability.dataset.availability) {
